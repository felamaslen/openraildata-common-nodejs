...
class StationMessage {
  ...
  constructor(payload = {}) {
    ...
    this._stations = (payload.Station && Array.isArray(payload.Station))
   ...
   */
  get severity() {
    return (this._payload.sev !== undefined && Number.isNaN(this._payload.sev) !== 'NaN')
   ...
   */
  get severityString() {
    if (this._payload.sev !== undefined && Number.isNaN(this._payload.sev) !== 'NaN') {
